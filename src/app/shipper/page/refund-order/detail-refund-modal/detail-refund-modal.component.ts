...
@Component({
  selector: 'detail-refund-modal',
  templateUrl: './detail-refund-modal.component.html',
  styleUrls: ['./detail-refund-modal.component.css']
})
export class DetailRefundModalComponent implements OnInit {
